...
test("player1 is scissors, player2 is scissors","Tie",check("scissor","scissor"))
test("player1 is scissors, player2 isrock","Player2 wins",check("scissor","rock"))
test("player1 is rock, player2 is paper","Player2 wins",check("rock","paper"))
test("player1 is rock, player2 is scissors","Player1 wins",check("rock","scissor"))
test("player1 is rock, player2 is rock","Tie",check("rock","rock"))
test("player1 is paper, player2 is paper","Tie",check("paper","paper"))
test("player1 is paper, player2 is scissors","Player2 wins",check("paper","scissor"))
