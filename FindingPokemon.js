let rawData={
  ...
  let abilit= rawData.abilities
  let base= rawData.base_experience
  let height= rawData.height
//  let url=rawData.held_items.item.url
  let sprites=rawData.sprites
  let names=[rawData.stats[0].stat.name,rawData.stats[1].stat.name,rawData.stats[2].stat.name,rawData.stats[3].stat.name,rawData.stats[4].stat.name,rawData.stats[5].stat.name]
  let slot=rawData.types[0].slot
  let weight=rawData.weight
 // let movieVersion=rawData.moves[1].version_group_details[0]
  console.log(abilit)
  console.log(base)
  console.log(height)
//  console.log(url)
